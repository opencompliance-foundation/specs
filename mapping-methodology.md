...
- That same pilot has now also promoted the network, transport, and storage-confidentiality extensions `oc.net-02`, `oc.net-03`, `oc.net-04`, and `oc.crypt-01`, so the next depth work is no longer "publish the pending wave" but "use the new private ISO 27001 / SOC 2 framework-depth reports to choose the next exact-anchor and decomposition slice."
