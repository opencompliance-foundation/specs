...
- The medium and issued ExampleCo corridors now also carry narrow encryption-at-rest, unique-infrastructure-identity, and environment-segmentation controls with typed storage, identity, and architecture exports, Lean-backed proofs, refreshed witness material, updated lifecycle drift outputs, and regenerated public signature manifests.
