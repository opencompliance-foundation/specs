# U.S. Sector Mapping Status

This file is a public-safe status view for the first U.S. sector-regime depth wave inside OpenCompliance.

## HIPAA Privacy and Breach mapping program
...
- `HIPAA Privacy Rule`: mapped `3`, implemented `3`, exact-reviewed `3`
- `HIPAA Breach Notification Rule`: mapped `2`, implemented `2`, exact-reviewed `2`

### Workstreams

- `Public-law and regulation decomposition`: `partial`
...
- `Typed claim coverage`: `partial`
  - Current state: The current overlap splits into 1 decidable, 4 attestation, and 0 judgment controls.
...
- `Lean coverage`: `partial`
  - Current state: 1 currently overlapped controls are Lean-backed in the public corridor.
...
- `External review`: `program_defined`
  ...
  - Remaining work: Run the review program with sector-specialist counsel, operators, and privacy engineers once the next control wave is ready.

## GLBA and NYDFS mapping program

- Frameworks in scope: `2`
- Frameworks with current mappings: `2`
- Unique mapped public controls: `7`
- Unique implemented public controls: `7`
- Reviewed exact-anchor entries: `13`
- Candidate exact-anchor entries: `0`
- Blocked exact-anchor entries: `0`

### Frameworks

- `GLBA Safeguards Rule`: mapped `6`, implemented `6`, exact-reviewed `6`
- `NYDFS 23 NYCRR Part 500`: mapped `7`, implemented `7`, exact-reviewed `7`
...
- `Public-law and regulation decomposition`: `partial`
  ...
  - Remaining work: Widen the current narrow overlap into a fuller obligation graph without collapsing rights, notification, and documentary requirements into fake machine proof.
- `Public-control normalization`: `partial`
  - Current state: 7 unique public controls currently overlap this program, with 7 already exercised by fixtures.
  - Remaining work: Promote the next narrow controls only when their route, exact-anchor, and claim-schema boundaries are stable enough to stay honest.
- `Reviewed exact-anchor corridor`: `partial`
  - Current state: The current wave records 13 reviewed exact-anchor entries and 0 candidate entries across the in-scope frameworks.
  - Remaining work: Increase reviewed exact-anchor coverage while keeping gaps explicit and resisting family-proxy inflation.
- `Typed claim coverage`: `partial`
  - Current state: The current overlap splits into 3 decidable, 4 attestation, and 0 judgment controls.
  - Remaining work: Close the next typed evidence and attestation gaps before widening the public verifier surface for these regimes.
- `Lean coverage`: `partial`
  - Current state: 3 currently overlapped controls are Lean-backed in the public corridor.
  - Remaining work: Keep Lean usage narrow and technical: only widen it where the regime obligation really reduces to a decidable systems claim.
- `Fixture rollout`: `complete`
  - Current state: 7 of 7 mapped controls currently appear in public fixture corridors.
  - Remaining work: Turn the next rights, vendor, breach, and retention slices into replayable fixture-backed corridors instead of documentation-only backlog.
- `External review`: `program_defined`
  - Current state: A dedicated sector-regime review program now defines the reviewer roles and pass gates for health, finance, and California privacy-law scrutiny.
  - Remaining work: Run the review program with sector-specialist counsel, operators, and privacy engineers once the next control wave is ready.

## CCPA/CPRA mapping program

- Frameworks in scope: `1`
- Frameworks with current mappings: `1`
- Unique mapped public controls: `7`
- Unique implemented public controls: `7`
- Reviewed exact-anchor entries: `7`
- Candidate exact-anchor entries: `0`
- Blocked exact-anchor entries: `0`

### Frameworks

- `CCPA/CPRA`: mapped `7`, implemented `7`, exact-reviewed `7`
...
- `Public-control normalization`: `partial`
  ...
  - Remaining work: Promote the next narrow controls only when their route, exact-anchor, and claim-schema boundaries are stable enough to stay honest.
- `Reviewed exact-anchor corridor`: `partial`
  - Current state: The current wave records 7 reviewed exact-anchor entries and 0 candidate entries across the in-scope frameworks.
  - Remaining work: Increase reviewed exact-anchor coverage while keeping gaps explicit and resisting family-proxy inflation.
- `Typed claim coverage`: `partial`
  - Current state: The current overlap splits into 1 decidable, 5 attestation, and 1 judgment controls.
  - Remaining work: Close the next typed evidence and attestation gaps before widening the public verifier surface for these regimes.
- `Lean coverage`: `partial`
  - Current state: 1 currently overlapped controls are Lean-backed in the public corridor.
  - Remaining work: Keep Lean usage narrow and technical: only widen it where the regime obligation really reduces to a decidable systems claim.
